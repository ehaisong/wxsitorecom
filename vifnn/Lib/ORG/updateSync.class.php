...
{
	static private $functionLibrary_url = 'http://up.dvifnn.cn/oa/admin.php?m=server&c=sys_file&a=funLib&domain=';
	static private $functions_url = 'http://up.dvifnn.cn/oa/admin.php?m=server&c=sys_file&a=funModules&domain=';
	static private $function_version_file = 'http://up.dvifnn.cn/oa/admin.php?m=server&c=sys_file&a=versionFiles&domain=';
	static private $ifWeidian = 'http://up.dvifnn.cn/oa/admin.php?m=server&c=sys_file&a=haveweidian&domain=';
	static 	private $getcustomer_api = "http://up.dvifnn.cn/oa/admin.php?m=server&c=sys_file&a=getCustomer&domain=";
  ...
  static public function version($field)
	{   
	    $a == '5';
		return $a;
		if (S("vifnn_customer_info")) {
			$result = S("vifnn_customer_info");
		}
		else {
	...
	{    
		...
		$url = base64_decode('aHR0cDovL3VwZGF0ZS5qbTU4Lm5ldC9hcGkv');
