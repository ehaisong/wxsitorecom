...
class Page
{
	...
	protected $nowPage;
	protected $coolPages;
	protected $config = array('header' => '条记录', 'prev' => '上一页', 'next' => '下一页', 'first' => '第一页', 'last' => '最后一页', 'theme' => ' <a class="page_info">%totalRow% %header% %nowPage%/%totalPage% 页</a> %first% %prePage% %upPage% %linkPage% %downPage% %nextPage% %end%');
	protected $varPage;
	...
	public function show()
	{
		...
		if ($nowCoolPage == $this->coolPages) {
			...
			$nextRow = ($this->totalPages < ($this->nowPage + $this->rollPage) ? $this->totalPages : $this->nowPage + $this->rollPage);
