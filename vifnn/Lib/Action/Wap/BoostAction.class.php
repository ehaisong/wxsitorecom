...
class BoostAction extends WapAction
{
	public $jump_url;
	public function _initialize()
	{
		...
		$this->jump_url = $this->boost->getServerUrl() . 'index.php?m=Boost&c=start&a=index';
	...
	public function jump()
	{
		...
		if (empty($data['uboostid'])) {
			$data['uboostid'] = $this->_get('uboostid');
		}
