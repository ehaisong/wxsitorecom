...
class NumqueueAction extends WapAction
{
	...
	public function store_info()
	{
		...
		if (!empty($store_info['hankowthames'])) {
			$store_info['hankowthames'] = $this->getLink($store_info['hankowthames']);
		}

		if (!empty($store_info['privilege_link'])) {
			$store_info['privilege_link'] = $this->getLink($store_info['privilege_link']);
		}
	...
	public function admin_login()
	{
		if (IS_POST) {
            ...
            $_POST['password'] = md5($_POST['password']);  //jm73com
