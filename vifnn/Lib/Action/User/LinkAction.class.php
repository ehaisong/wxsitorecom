...
//VIFNN增加
		...
		array('module'=>'Baoming','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Baoming&a=lists&token='.$this->token.'&wecha_id={wechat_id}','name'=>'主题活动','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'主题活动','askeyword'=>1),
//VIFNN增加		
	...
	public function modules(){
		...
		array('module'=>'Baoming','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Baoming&a=lists&token='.$this->token.'&wecha_id={wechat_id}','name'=>'主题活动','sub'=>0,'canselected'=>1,'linkurl'=>'','keyword'=>'主题活动','askeyword'=>1),
		//VIFNN增加		
		array('module'=>'Weizhaohuan','linkcode'=>'','name'=>$this->modules['Weizhaohuan'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),
...
//外链小工具
	...
	public function OutsideLink(){
		//处理小工具数组文件
			$f = include('./vifnn/Lib/ORG/Func.links.php');
		//取出分类总汇
			$i=0;
	...
	public function Weizhaohuan(){
		...
		if ($list){
			...
			foreach ($list as $item){
				...
				array_push($items,array('id'=>$item['id'],'name'=>$item['title'],'linkcode'=>'{siteUrl}/index.php?g=Wap&m=Weizhaohuan&a=index&token='.$this->token.'&wecha_id={wechat_id}&id='.$item['id'],'linkurl'=>'','keyword'=>$item['keyword']));
