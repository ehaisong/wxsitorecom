...
class HardwareAction extends UserAction{
	public function _initialize() {
		parent::_initialize();
                //取打印机类型
                //$print_server = 'http://up.vifnn.com' . $_SERVER['HTTP_HOST'];
                $print_compay_info = file_get_contents($print_server);
                $print_compay_arr = unserialize($print_compay_info);
                $this->assign('print_compay_arr',$print_compay_arr);
	}
