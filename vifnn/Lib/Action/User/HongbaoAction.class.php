...
class HongbaoAction extends UserAction{
	...
	public function action_add(){
		...
		if(IS_POST){
			...
			if($_POST['max_money'] > $_POST['total_money']){
			...
			if(strlen($_POST['action_name']) > 32){
			...
			if(strlen($_POST['reply_title']) > 32){
			...
			if(strlen($_POST['reply_content']) > 128){
			...
			if(strlen($_POST['action_desc']) > 256){
