...
class AuthAction extends BaseAction
{
	...
	public $_accessListAction = array('bargain', 'seckill', 'crowdfunding', 'unitary', 'cutprice', 'lottery', 'red_packet', 'guajiang', 'jiugong', 'luckyfruit', 'goldenegg', 'voteimg', 'custom', 'card', 'game', 'live', 'research', 'forum', 'autumn', 'helping', 'cointree', 'donation', 'collectword', 'sentiment', 'frontpage', 'test', 'punish', 'shakelottery', 'yousetdiscount', 'popularity', 'problem', 'seniorscene','auction');
	private $_allowModel = array(
		'select' => array('Bargain', 'SeckillAction', 'Crowdfunding', 'Unitary', 'Cutprice', 'RedPacket', 'Lottery', 'Voteimg', 'CustomSet', 'Cards', 'Games', 'Research', 'ForumConfig', 'Live', 'Autumn', 'Helping', 'Guajiang', 'Jiugong', 'LuckyFruit', 'GoldenEgg', 'CashierActivity', 'BargainKanuser', 'SeckillBaseShop', 'CrowdfundingOrder', 'UnitaryLucknum', 'CutpriceOrder', 'Cointree', 'Donation', 'Collectword', 'Sentiment', 'Frontpage_action', 'Test', 'Punish', 'Shakelottery', 'Yousetdiscount', 'Popularity', 'Problem_game', 'SeniorScene','Auction'),
		'update' => array('Nothing', 'Bargain', 'Seckill', 'Crowdfunding', 'Unitary', 'Cutprice', 'RedPacket', 'Lottery', 'Voteimg', 'CustomSet', 'Cards', 'Games', 'Research', 'ForumConfig', 'Live', 'Autumn', 'Helping', 'Guajiang', 'Jiugong', 'LuckyFruit', 'GoldenEgg', 'Cointree', 'Donation', 'Collectword', 'Sentiment', 'Frontpage_action', 'Test', 'Punish', 'Shakelottery', 'Yousetdiscount', 'Popularity', 'Problem_game', 'SeniorScene','Auction'),
	...
	{
		parent::_initialize();
		$this->_salt = C('encryption') ? C('encryption') : 'vifnn';
	}
	...
	public function signup()
	{
		...
		if ($this->_signVeryfy($_POST, $sign)) {
			...
			if (empty($wxuser)) {
				...
				$save = array('winxintype' => $_POST['wxtype']);
	...
	private function _login()
	{
		...
		if ($res && ($pwd === $res['password'])) {
			...
			if (!$wxuser) {
				exit(json_encode($this->_status[40202]));
			}
