...
class DatabaseAction extends BackAction{
 ...
 public function back(){
	...
	$dir="./vifnnData/database/".time().".sql";
    if($mr->backup() == true){
	   $this->success("备份成功");
	}
 }
 ...
 public function filemd() {
    $md1 = md5_file('./vifnn/Lib/Action/System/UpdateAction.class.php');
	$md2 = md5_file('./vifnn/Lib/Action/System/UpdatecAction.class.php');
	$md3 = md5($md1.$md2);
	return $md3;	
}
  ...
  public function delete(){
    $filename="./vifnnData/database/".strtotime($_GET['time']).".sql";
	//dump($filename);
    unlink($filename);
