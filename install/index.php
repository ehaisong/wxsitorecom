...
'license'=>'<div class="license"><h1>系统安装协议</h1>
                <p>版权所有 (c)2012-2016 保留所有权利。 </p>
				<p>感谢您选择微风CMS微信公共平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
			<strong>一、本授权协议适用且仅适用于 2016 版本，官方对本授权协议的最终解释权。</strong>
			    <p></p>
			<strong>二、协议许可的权利 </strong>
				<p>1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </p>
				<p>2、您可以在协议规定的约束和限制范围内修改 微风CMS微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微风CMS微信公共平台，还是部份栏目使用 微信公共平台，在你使用了 微风CMS微信公共平台的网站主页上必须加上 微风CMS微信公共平台  官方网址(<a href="http://www.vifnn.com" target="_blank">www.vifnn.com</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 微风CMS微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2016年春</p>
                <p align=right>BY 微风CMS微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微风CMS微信公共平台V'.SOFT_VERSION.' 安装程序',
...
'dbname' => '数据库名',
'tablepre' => '数据表前缀',
'tablepre_comment' => '此项不可修改',
'dbport' =>'数据库端口',
'tips_admininfo' => '网站信息',
'username' => '管理员账号',
'username_comment' => '管理员账号用admin 不可修改',
'password' => '管理员密码',
...
if (file_exists('../vifnnData/install.lock')){
	@header("Content-type: text/html; charset=UTF-8");
	echo "系统已经安装过了，如果要重新安装，那么请删除vifnndata目录下的install.lock文件";
	exit;
...
(1, '".$username."', '".$password."', 5, 1, '', 1383453875, '127.0.0.1', '')");
			//新增一个标识文件，用来屏蔽重新安装
			$fp = @fopen(ROOT_PATH.'vifnnData/install.lock','wb+');
			@fclose($fp);
		}else{
...
<meta content="微风CMS微信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 微风CMS微信公共平台(c)2012-2016</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function runquery($sql) {
	...
	$sql = str_replace("\r", "\n", str_replace('vifnn_', $tablepre, $sql));
	$ret = array();
	$num = 0;
	foreach(explode(";\n", trim($sql)) as $query) {
		$ret[$num] = '';
